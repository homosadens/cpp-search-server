...
//было замечание, что в ParseQuery нет проверки запроса на спец символы. Но она у меня находится в методе SplitIntoWordsNoStop, потому я сочла, что второй раз проверять в ParseQuery то же самое не имеет смыcла

...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus act_status) const {
         return FindTopDocuments(raw_query, [act_status](int document_id, DocumentStatus status, int rating) { return status == act_status;});
    }
